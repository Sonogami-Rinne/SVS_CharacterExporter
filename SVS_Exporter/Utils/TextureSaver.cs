...
namespace SVSExporter.Utils
{
    ...
    {
        public static void SaveTexture(Color32[] data, int textureWidth, int textureHeight, string path)
        {
            PngWriter.SaveRgbaToPng(data,textureWidth, textureHeight, path);
        }
